      ...
      <div className="p-2">
        ...
        <li className="mt-20">
            <h3 className="dark:text-neutral-300 font-semibold cursor-pointer"
              onClick={() => navigate("/poor-man-ci-cd")}
            >Poor's man CI/CD</h3>
            <span className="text-xs dark:text-neutral-500 font-thin">2024-04-21</span>
            <div className="mt-4">
              <p className="text-sm font-light dark:text-neutral-400">
                A simple way to deploy your app using github actions and VPS.
              </p>
            </div>
          ...
          <li className="mt-20">
            <h3 className="dark:text-neutral-300 font-semibold cursor-pointer"
              onClick={() => navigate("/makefile-for-go")}
